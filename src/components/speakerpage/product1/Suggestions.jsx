...
import Image1Desktop from "../../../assets/shared/desktop/image-zx7-speaker.jpg"
import Image1Tablet from "../../../assets/shared/tablet/image-zx7-speaker.jpg"
import Image1Mobile from "../../../assets/shared/mobile/image-zx7-speaker.jpg"
        ...
        <div className="max-w-[1110px] w-[90%] lg:w-[80%] mx-auto my-16">
            ...
            <div className="flex flex-col md:flex-row gap-16 md:gap-8">
                <div className="flex flex-col  items-center gap-4">
                    ...
                    <h5 className="h5">ZX7 Speaker</h5>
                    <button
